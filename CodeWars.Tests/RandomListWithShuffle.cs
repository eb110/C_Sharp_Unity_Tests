...
namespace CodeWars.Tests
{
    ...
    public class SolutionTest
    {
        ...
        public bool Vectors_Directed_SameDirections(int x1, int x2, int y1, int y2) => KataOld.Collinearity(x1, x2, y1, y2);

        [TestCase(1, 1, -1, -1, ExpectedResult = true)]
        [TestCase(1, -2, -2, 4, ExpectedResult = true)]
        public bool Vectors_Directed_OppositeDirections(int x1, int x2, int y1, int y2) => KataOld.Collinearity(x1, x2, y1, y2);

        [TestCase(1, 1, 6, 1, ExpectedResult = false)]
        [TestCase(1, 2, 1, -2, ExpectedResult = false)]
        public bool Vectors_Directed_DifferentDirections(int x1, int x2, int y1, int y2) => KataOld.Collinearity(x1, x2, y1, y2);
        ...
        public bool Vectors_Contains_Zeros(int x1, int x2, int y1, int y2) => KataOld.Collinearity(x1, x2, y1, y2);
        ...
        public void RandomTest()
        {
            ...
            {
                bool actual = KataOld.Collinearity(Vector[0], Vector[1], Vector[2], Vector[3]);
